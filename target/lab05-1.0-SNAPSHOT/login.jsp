...
<div class="image-three" id="lab">
    <div class="wrapper">
        <div class="sign-in">
            <form action="/lab05_war_exploded/doLogin" method="post">
                <%
                    if(error != null){
                %>
                ...
                <div class="name-mail-password">
                    <input  name="username" <% if (request.getParameter("username")!=null){ %>
                            value="<%=request.getParameter("username")%>" <%} %> id="name-mail" type="text" placeholder="username or mail" class="pix_text" />
                    <input  name="password" id="password" type="text" placeholder="password" class="pix_text" />
                </div>
